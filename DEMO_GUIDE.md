...
**A:** The WebSocket handler intercepts images and directly calls Gemini Vision API analysis tools. This new architecture bypasses the multimodal agent's limitation with blob extraction.

### Q: How does it know the order history?
**A:** The system cross-references customer ID with past purchases in Firestore, identifying products by visual similarity and metadata.

### Q: What if the child doesn't want to talk?
**A:** The AI gracefully handles non-responses and continues with parent-only consultation.

### Q: How many products are in the catalog?
**A:** 150+ products across categories (Home Decor, Furniture, Electronics, Fashion, etc.)

### Q: Can it handle multiple rooms?
**A:** Yes! The consultation flow supports all room types: bedroom, living room, office, kitchen, etc.
...
- [ ] Test credentials ready (Nova Anderson)
- [ ] Test photos ready (bedroom images)
- [ ] Browser console open (for debugging)
- [ ] Server logs accessible (`tail -f /tmp/server.log`)
- [ ] Microphone tested (for voice input)
- [ ] Camera tested (for photo capture)
- [ ] Cart cleared (fresh start)
- [ ] Demo script reviewed
- [ ] Timing practiced (7-minute target)

---

## Closing Statement

> "This demo showcases an AI assistant that goes beyond simple product search. It combines computer vision, order history, personalization, and empathetic conversation to create a truly magical shopping experience - especially for life moments like preparing a child for their next stage of growth."

---

**Demo Duration:** 7 minutes
**Last Updated:** April 8, 2026
**Version:** 2.0 (New Image Interceptor Architecture)
